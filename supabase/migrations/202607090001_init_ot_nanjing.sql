-- Converted from db/springboot655ms.sql for the public demo deployment.
-- Data is isolated in the ot_nanjing schema and can be re-applied safely.
...
CREATE TABLE IF NOT EXISTS cantingxinxi (
  ...
  cantingdidian varchar(200) DEFAULT NULL,
  renjunxiaofei integer DEFAULT NULL,
  yudingjiage integer DEFAULT NULL,
  cantingjieshao text,
  cantingtupian text,
...
CREATE TABLE IF NOT EXISTS cantingyuding (
  id bigint GENERATED BY DEFAULT AS IDENTITY NOT NULL,
  addtime timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  cantingmingcheng varchar(200) DEFAULT NULL,
  cantingdidian varchar(200) DEFAULT NULL,
  yudingjiage double precision DEFAULT NULL,
  yudingshijian timestamp DEFAULT NULL,
  yudingshuoming varchar(200) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS discussjiaotongluxian (
  id bigint GENERATED BY DEFAULT AS IDENTITY NOT NULL,
  addtime timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  refid bigint NOT NULL,
  userid bigint NOT NULL,
...
CREATE TABLE IF NOT EXISTS discusslvxingriji (
  id bigint GENERATED BY DEFAULT AS IDENTITY NOT NULL,
  addtime timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  refid bigint NOT NULL,
  userid bigint NOT NULL,
...
CREATE TABLE IF NOT EXISTS jiaotongluxian (
  id bigint GENERATED BY DEFAULT AS IDENTITY NOT NULL,
  addtime timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  luxianmingcheng varchar(200) DEFAULT NULL,
  luxianleixing varchar(200) DEFAULT NULL,
  shifadi varchar(200) DEFAULT NULL,
  zhongdiandi varchar(200) DEFAULT NULL,
  quanchengjuli varchar(200) DEFAULT NULL,
  luxianxiangqing text,
  luxiantupian text,
  PRIMARY KEY (id)
);
...
CREATE TABLE IF NOT EXISTS jingdianxinxi (
  id bigint GENERATED BY DEFAULT AS IDENTITY NOT NULL,
  addtime timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  jingdianmingcheng varchar(200) DEFAULT NULL,
  jingdiandizhi varchar(200) DEFAULT NULL,
  jingdiandengji varchar(200) DEFAULT NULL,
  menpiaojiage integer DEFAULT NULL,
  jingdiandianhua varchar(200) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS jiudianxinxi (
  ...
  jiudianleixing varchar(200) NOT NULL,
  jiudiandizhi varchar(200) DEFAULT NULL,
  fangjianleixing varchar(200) DEFAULT NULL,
  yuyuejiage double precision DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS jiudianyuding (
  id bigint GENERATED BY DEFAULT AS IDENTITY NOT NULL,
  addtime timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  jiudianmingcheng varchar(200) DEFAULT NULL,
  jiudianleixing varchar(200) DEFAULT NULL,
  jiudiandizhi varchar(200) DEFAULT NULL,
  fangjianleixing varchar(200) DEFAULT NULL,
  yuyuejiage double precision DEFAULT NULL,
  yudingshijian timestamp DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS lvxingriji (
  id bigint GENERATED BY DEFAULT AS IDENTITY NOT NULL,
  addtime timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  lvxingdidian varchar(200) DEFAULT NULL,
  lvxingleixing varchar(200) DEFAULT NULL,
  lvxingtianshu integer DEFAULT NULL,
  lvxingneirong text,
  lvxingtupian text,
  zhanghao varchar(200) DEFAULT NULL,
  xingming varchar(200) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS lvyouguihua (
  id bigint GENERATED BY DEFAULT AS IDENTITY NOT NULL,
  addtime timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  mudedi varchar(200) DEFAULT NULL,
  chufashijian timestamp DEFAULT NULL,
  yujitianshu integer DEFAULT NULL,
  lvyouluxian text,
  guihuaneirong text,
  zhanghao varchar(200) DEFAULT NULL,
  xingming varchar(200) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS menpiaoyuding (
  id bigint GENERATED BY DEFAULT AS IDENTITY NOT NULL,
  addtime timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  jingdianmingcheng varchar(200) DEFAULT NULL,
  jingdiandizhi varchar(200) DEFAULT NULL,
  menpiaojiage double precision DEFAULT NULL,
  jingdiandengji varchar(200) DEFAULT NULL,
  yudingshijian timestamp DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS tianqiyubao (
  id bigint GENERATED BY DEFAULT AS IDENTITY NOT NULL,
  addtime timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  chengshi varchar(200) DEFAULT NULL,
  fengmian text,
  tianqi varchar(200) DEFAULT NULL,
  qiwen varchar(200) DEFAULT NULL,
  shidu varchar(200) DEFAULT NULL,
  fengxiang varchar(200) DEFAULT NULL,
  fengsu varchar(200) DEFAULT NULL,
  shiyichuxing varchar(200) DEFAULT NULL,
  chuanyituijian varchar(200) DEFAULT NULL,
  gengxinshijian timestamp DEFAULT NULL,
  PRIMARY KEY (id)
);
...
CREATE TABLE IF NOT EXISTS yonghu (
  ...
  nianling integer DEFAULT NULL,
  shouji varchar(200) DEFAULT NULL,
  touxiang text,
  PRIMARY KEY (id),
  CONSTRAINT yonghu_zhanghao_key UNIQUE (zhanghao)
);
...
SELECT setval(pg_get_serial_sequence('ot_nanjing.cantingxinxi', 'id'), COALESCE((SELECT MAX(id) FROM cantingxinxi), 1));
SELECT setval(pg_get_serial_sequence('ot_nanjing.cantingyuding', 'id'), COALESCE((SELECT MAX(id) FROM cantingyuding), 1));
SELECT setval(pg_get_serial_sequence('ot_nanjing.config', 'id'), COALESCE((SELECT MAX(id) FROM config), 1));
SELECT setval(pg_get_serial_sequence('ot_nanjing.discusscantingxinxi', 'id'), COALESCE((SELECT MAX(id) FROM discusscantingxinxi), 1));
SELECT setval(pg_get_serial_sequence('ot_nanjing.discussjiaotongluxian', 'id'), COALESCE((SELECT MAX(id) FROM discussjiaotongluxian), 1));
SELECT setval(pg_get_serial_sequence('ot_nanjing.discussjingdianxinxi', 'id'), COALESCE((SELECT MAX(id) FROM discussjingdianxinxi), 1));
SELECT setval(pg_get_serial_sequence('ot_nanjing.discussjiudianxinxi', 'id'), COALESCE((SELECT MAX(id) FROM discussjiudianxinxi), 1));
SELECT setval(pg_get_serial_sequence('ot_nanjing.discusslvxingriji', 'id'), COALESCE((SELECT MAX(id) FROM discusslvxingriji), 1));
SELECT setval(pg_get_serial_sequence('ot_nanjing.jiaotongluxian', 'id'), COALESCE((SELECT MAX(id) FROM jiaotongluxian), 1));
SELECT setval(pg_get_serial_sequence('ot_nanjing.jingdianxinxi', 'id'), COALESCE((SELECT MAX(id) FROM jingdianxinxi), 1));
SELECT setval(pg_get_serial_sequence('ot_nanjing.jiudianxinxi', 'id'), COALESCE((SELECT MAX(id) FROM jiudianxinxi), 1));
SELECT setval(pg_get_serial_sequence('ot_nanjing.jiudianyuding', 'id'), COALESCE((SELECT MAX(id) FROM jiudianyuding), 1));
SELECT setval(pg_get_serial_sequence('ot_nanjing.lvxingriji', 'id'), COALESCE((SELECT MAX(id) FROM lvxingriji), 1));
SELECT setval(pg_get_serial_sequence('ot_nanjing.lvyouguihua', 'id'), COALESCE((SELECT MAX(id) FROM lvyouguihua), 1));
SELECT setval(pg_get_serial_sequence('ot_nanjing.menpiaoyuding', 'id'), COALESCE((SELECT MAX(id) FROM menpiaoyuding), 1));
SELECT setval(pg_get_serial_sequence('ot_nanjing.news', 'id'), COALESCE((SELECT MAX(id) FROM news), 1));
SELECT setval(pg_get_serial_sequence('ot_nanjing.storeup', 'id'), COALESCE((SELECT MAX(id) FROM storeup), 1));
SELECT setval(pg_get_serial_sequence('ot_nanjing.tianqiyubao', 'id'), COALESCE((SELECT MAX(id) FROM tianqiyubao), 1));
SELECT setval(pg_get_serial_sequence('ot_nanjing.token', 'id'), COALESCE((SELECT MAX(id) FROM token), 1));
SELECT setval(pg_get_serial_sequence('ot_nanjing.users', 'id'), COALESCE((SELECT MAX(id) FROM users), 1));
SELECT setval(pg_get_serial_sequence('ot_nanjing.yonghu', 'id'), COALESCE((SELECT MAX(id) FROM yonghu), 1));
