...
<div :style='{"border":"2px solid #a4d9b7","padding":"20px","margin":"20px auto 0","borderRadius":"8px","flexWrap":"wrap","background":"#fff","width":"1200px","position":"relative"}'>
    <el-form
      ...
      label-width="200px"
    >
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' label="用户名" prop="mudedi">
            <el-input v-model="ruleForm.mudedi" 
                placeholder="请输入内容" clearable></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' label="鍑哄彂鏃堕棿" prop="chufashijian" >
              <el-date-picker
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' label="棰勮澶╂暟" prop="yujitianshu">
            <el-input v-model="ruleForm.yujitianshu" 
                placeholder="棰勮澶╂暟" clearable ></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' label="鏃呮父璺嚎" prop="lvyouluxian">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="鏃呮父璺嚎"
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' label="瑙勫垝鍐呭" prop="guihuaneirong">
            <editor 
...
<script>
  export default {
    ...
    // 澶氱骇鑱斿姩鍙傛暟
      // 澶氱骇鑱斿姩鍙傛暟
      info(id) {
        this.$http.get('lvyouguihua/detail/${id}', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
        ...
        this.$refs["ruleForm"].validate(valid => {
          if(valid) {
            ...
            if(crossrefid && crossuserid) {
                 ...
                 this.$http.get('lvyouguihua/list', {
                  params: params
                 }).then(res => {
                     if(res.data.data.total>=crossoptnum) {
                         ...
                         // 璺ㄨ〃璁＄畻
                          ...
                          this.$http.post('lvyouguihua/add', this.ruleForm).then(res => {
                              if (res.data.code == 0) {
                                  this.$message({
                                      message: '鎿嶄綔鎴愬姛',
                                      type: 'success',
