...
<div :style='{"border":"2px solid #a4d9b7","padding":"20px","margin":"20px auto 0","borderRadius":"8px","flexWrap":"wrap","background":"#fff","width":"1200px","position":"relative"}'>
    ...
    >
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' label="瀵嗙爜" prop="password">
            <el-input v-model="ruleForm.password" 
                placeholder="瀵嗙爜" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' label="瑙掕壊" prop="role">
            <el-input v-model="ruleForm.role" 
                placeholder="瑙掕壊" clearable ></el-input>
          </el-form-item>
