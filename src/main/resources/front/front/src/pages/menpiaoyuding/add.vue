    ...
    >
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' label="鏅偣绛夌骇" prop="jingdiandengji">
            <el-input v-model="ruleForm.jingdiandengji" 
                placeholder="鏅偣绛夌骇" clearable ></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' label="澶囨敞" prop="beizhu">
            <el-input v-model="ruleForm.beizhu" 
                placeholder="澶囨敞" clearable ></el-input>
          </el-form-item>
...
<script>
  export default {
    ...
    // 澶氱骇鑱斿姩鍙傛暟
      // 澶氱骇鑱斿姩鍙傛暟
      info(id) {
        this.$http.get('menpiaoyuding/detail/${id}', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
                  ...
                  params: params
                     ...
                     if(res.data.data.total>=crossoptnum) {
                         ...
                         // 璺ㄨ〃璁＄畻
                          ...
                          this.$http.post('menpiaoyuding/add', this.ruleForm).then(res => {
                              if (res.data.code == 0) {
                                  this.$message({
                                      message: '鎿嶄綔鎴愬姛',
                                      type: 'success',
