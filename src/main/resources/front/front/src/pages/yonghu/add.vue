...
<div :style='{"border":"2px solid #a4d9b7","padding":"20px","margin":"20px auto 0","borderRadius":"8px","flexWrap":"wrap","background":"#fff","width":"1200px","position":"relative"}'>
    ...
    >
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' label="瀵嗙爜" prop="mima">
            <el-input v-model="ruleForm.mima" 
                placeholder="瀵嗙爜" clearable ></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}'  label="鎬у埆" prop="xingbie">
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' label="骞撮緞" prop="nianling">
            <el-input v-model="ruleForm.nianling" 
                placeholder="骞撮緞" clearable ></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' label="澶村儚" v-if="type!='cross' || (type=='cross' && !ro.touxiang)" prop="touxiang">
            <file-upload
            tip="鐐瑰嚮涓婁紶澶村儚"
            action="file/upload"
            :limit="3"
            ...
            <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' class="upload" v-else label="澶村儚" prop="touxiang">
    ...
    data() {
      return {
        ...
        rules: {
          ...
          xingming: [
            { required: true, message: '濮撳悕涓嶈兘涓虹┖', trigger: 'blur' },
          ],
          xingbie: [
          ],
          nianling: [
