...
<div :style='{"border":"2px solid #a4d9b7","padding":"20px","margin":"20px auto 0","borderRadius":"8px","flexWrap":"wrap","background":"#fff","width":"1200px","position":"relative"}'>
    <el-form
      ...
      label-width="200px"
    >
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' label="鏅偣鍚嶇О" prop="jingdianmingcheng">
            <el-input v-model="ruleForm.jingdianmingcheng" 
                placeholder="鏅偣鍚嶇О" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' label="鏅偣鍦板潃" prop="jingdiandizhi">
            <el-input v-model="ruleForm.jingdiandizhi" 
                placeholder="鏅偣鍦板潃" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}'  label="鏅偣绛夌骇" prop="jingdiandengji">
            <el-select v-model="ruleForm.jingdiandengji" placeholder="璇烽€夋嫨鏅偣绛夌骇"  >
              <el-option
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' label="闂ㄧエ浠锋牸" prop="menpiaojiage">
            <el-input v-model="ruleForm.menpiaojiage" 
                placeholder="闂ㄧエ浠锋牸" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' label="鏅偣鐢佃瘽" prop="jingdiandianhua">
            <el-input v-model="ruleForm.jingdiandianhua" 
                placeholder="鏅偣鐢佃瘽" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' label="鏅偣鍥剧墖" v-if="type!='cross' || (type=='cross' && !ro.jingdiantupian)" prop="jingdiantupian">
            <file-upload
            tip="鐐瑰嚮涓婁紶鏅偣鍥剧墖"
            action="file/upload"
            :limit="3"
            ...
            <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' class="upload" v-else label="鏅偣鍥剧墖" prop="jingdiantupian">
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' label="鏅偣浠嬬粛" prop="jingdianjieshao">
            <editor 
