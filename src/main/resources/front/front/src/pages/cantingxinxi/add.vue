...
<div :style='{"border":"2px solid #a4d9b7","padding":"20px","margin":"20px auto 0","borderRadius":"8px","flexWrap":"wrap","background":"#fff","width":"1200px","position":"relative"}'>
    <el-form
      ...
      label-width="200px"
    >
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' label="椁愬巺鍚嶇О" prop="cantingmingcheng">
            <el-input v-model="ruleForm.cantingmingcheng" 
                placeholder="椁愬巺鍚嶇О" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' label="椁愬巺鍦扮偣" prop="cantingdidian">
            <el-input v-model="ruleForm.cantingdidian" 
                placeholder="椁愬巺鍦扮偣" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' label="浜哄潎娑堣垂" prop="renjunxiaofei">
            <el-input v-model="ruleForm.renjunxiaofei" 
                placeholder="浜哄潎娑堣垂" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' label="棰勮浠锋牸" prop="yudingjiage">
            <el-input v-model="ruleForm.yudingjiage" 
                placeholder="棰勮浠锋牸" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' label="椁愬巺鍥剧墖" v-if="type!='cross' || (type=='cross' && !ro.cantingtupian)" prop="cantingtupian">
            <file-upload
            tip="鐐瑰嚮涓婁紶椁愬巺鍥剧墖"
            action="file/upload"
            :limit="3"
            ...
            <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' class="upload" v-else label="椁愬巺鍥剧墖" prop="cantingtupian">
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' label="椁愬巺浠嬬粛" prop="cantingjieshao">
            <editor 
...
<script>
  export default {
    ...
    // 澶氱骇鑱斿姩鍙傛暟
      // 澶氱骇鑱斿姩鍙傛暟
      info(id) {
        this.$http.get('cantingxinxi/detail/${id}', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
        ...
        this.$refs["ruleForm"].validate(valid => {
          if(valid) {
            ...
            if(crossrefid && crossuserid) {
                 ...
                 this.$http.get('cantingxinxi/list', {
                  params: params
                 }).then(res => {
                     if(res.data.data.total>=crossoptnum) {
                         ...
                         // 璺ㄨ〃璁＄畻
                          ...
                          this.$http.post('cantingxinxi/add', this.ruleForm).then(res => {
                              if (res.data.code == 0) {
                                  this.$message({
                                      message: '鎿嶄綔鎴愬姛',
                                      type: 'success',
