...
<div>
	...
	<div class="detail-preview" :style='{"width":"1200px","padding":"0 0 20px","margin":"0px auto","position":"relative","background":"none"}'>
		<div class="attr" :style='{"border":"2px solid #a4d9b7","padding":"20px","margin":"20px 0 0 0","overflow":"hidden","borderRadius":"8px","flexWrap":"wrap","background":"#fff","display":"flex","position":"relative","justifyContent":"space-between","height":"auto"}'>
			...
			<div class="zancai" :style='{"padding":"0","margin":"0 0","top":"536px","flexWrap":"wrap","background":"none","display":"flex","width":"500px","position":"absolute","justifyContent":"center"}'>
				<div :style='{"cursor":"pointer","padding":"10px 10px","margin":"0 20px 0 0","alignItems":"center","borderRadius":"8px","background":"#6bc18a","display":"flex","width":"auto","justifyContent":"center"}' v-if="!isThumbsupnum && !isCrazilynum" class="zan" @click="thumbsupOrCrazily(21)">
					...
					<span :style='{"color":"#fff","margin":"0 3px","fontSize":"14px"}'>璧炰竴涓?{{detail.thumbsupnum}})</span>
				</div>
				<div :style='{"cursor":"pointer","padding":"10px 10px","margin":"0 20px 0 0","alignItems":"center","borderRadius":"8px","background":"#6bc18a","display":"flex","width":"auto","justifyContent":"center"}' v-if="!isThumbsupnum && !isCrazilynum" class="cai" @click="thumbsupOrCrazily(22)">
					...
					<span :style='{"color":"#fff","margin":"0 3px","fontSize":"14px"}'>韪╀竴涓?{{detail.crazilynum}})</span>
				</div>
				<div :style='{"cursor":"pointer","padding":"10px 10px","margin":"0 20px 0 0","alignItems":"center","borderRadius":"8px","background":"#6bc18a","display":"flex","width":"auto","justifyContent":"center"}' v-if="isThumbsupnum" class="zan" @click="cancelThumbsupOrCrazily(21)">
					<i :style='{"color":"#fff","margin":"0 3px","fontSize":"14px"}' class="iconfont icon-dianzan"></i>
					<span :style='{"color":"#fff","margin":"0 3px","fontSize":"14px"}'>鍙栨秷璧?{{detail.thumbsupnum}})</span>
				</div>
				<div :style='{"cursor":"pointer","padding":"10px 10px","margin":"0 20px 0 0","alignItems":"center","borderRadius":"8px","background":"#6bc18a","display":"flex","width":"auto","justifyContent":"center"}' v-if="isCrazilynum" class="cai" @click="cancelThumbsupOrCrazily(22)">
					<i :style='{"color":"#fff","margin":"0 3px","fontSize":"14px"}' class="iconfont icon-iconfontzan"></i>
					<span :style='{"color":"#fff","margin":"0 3px","fontSize":"14px"}'>鍙栨秷韪?{{detail.crazilynum}})</span>
				</div>
			</div>
			...
			<div class="info" :style='{"minHeight":"570px","padding":"0 20px 20px","margin":"0px","borderRadius":"8px","background":"#f9f9f9","width":"600px","height":"auto","order":"2"}'>
				<div class="item" :style='{"padding":"10px","margin":"0 0 20px 0","borderColor":"#55b44b","alignItems":"center","background":"none","borderWidth":"0 0 1px 0","display":"flex","borderStyle":"solid","justifyContent":"space-between"}'>
					...
					<div @click="storeup(1)" v-show="!isStoreup" :style='{"cursor":"pointer","padding":"10px","borderRadius":"8px","background":"#6bc18a"}'><i v-if="true" :style='{"color":"#fff","fontSize":"14px"}' class="el-icon-star-off"></i><span :style='{"color":"#fff","fontSize":"14px"}'>鐐规垜鏀惰棌</span></div>
					<div @click="storeup(-1)" v-show="isStoreup" :style='{"cursor":"pointer","padding":"10px","borderRadius":"8px","background":"#6bc18a"}'><i v-if="true" :style='{"color":"#fff","fontSize":"14px"}' class="el-icon-star-on"></i><span :style='{"color":"#fff","fontSize":"14px"}'>鍙栨秷鏀惰棌</span></div>
				</div>
				...
				<div class="item" :style='{"padding":"4px","margin":"0 0 4px 0","borderColor":"rgba(85, 180, 75,.4)","background":"none","borderWidth":"0 0 1px 0 ","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px 0 0","color":"#333","textAlign":"left","width":"130px","fontSize":"14px","lineHeight":"24px","fontWeight":"bold","height":"40px"}'>閰掑簵绫诲瀷</div>
					<div  :style='{"width":"498px","padding":"0 10px","fontSize":"14px","lineHeight":"24px","color":"#666"}'>{{detail.jiudianleixing}}</div>
				</div>
				<div class="item" :style='{"padding":"4px","margin":"0 0 4px 0","borderColor":"rgba(85, 180, 75,.4)","background":"none","borderWidth":"0 0 1px 0 ","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px 0 0","color":"#333","textAlign":"left","width":"130px","fontSize":"14px","lineHeight":"24px","fontWeight":"bold","height":"40px"}'>閰掑簵鍦板潃</div>
					<div  :style='{"width":"498px","padding":"0 10px","fontSize":"14px","lineHeight":"24px","color":"#666"}'>{{detail.jiudiandizhi}}</div>
				</div>
				<div class="item" :style='{"padding":"4px","margin":"0 0 4px 0","borderColor":"rgba(85, 180, 75,.4)","background":"none","borderWidth":"0 0 1px 0 ","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px 0 0","color":"#333","textAlign":"left","width":"130px","fontSize":"14px","lineHeight":"24px","fontWeight":"bold","height":"40px"}'>鎴块棿绫诲瀷</div>
					<div  :style='{"width":"498px","padding":"0 10px","fontSize":"14px","lineHeight":"24px","color":"#666"}'>{{detail.fangjianleixing}}</div>
				</div>
				<div class="item" :style='{"padding":"4px","margin":"0 0 4px 0","borderColor":"rgba(85, 180, 75,.4)","background":"none","borderWidth":"0 0 1px 0 ","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px 0 0","color":"#333","textAlign":"left","width":"130px","fontSize":"14px","lineHeight":"24px","fontWeight":"bold","height":"40px"}'>棰勭害浠锋牸</div>
					<div  :style='{"width":"498px","padding":"0 10px","fontSize":"14px","lineHeight":"24px","color":"#666"}'>{{detail.yuyuejiage}}</div>
				</div>
				<div class="item" :style='{"padding":"4px","margin":"0 0 4px 0","borderColor":"rgba(85, 180, 75,.4)","background":"none","borderWidth":"0 0 1px 0 ","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px 0 0","color":"#333","textAlign":"left","width":"130px","fontSize":"14px","lineHeight":"24px","fontWeight":"bold","height":"40px"}'>鑱旂郴鐢佃瘽</div>
					<div  :style='{"width":"498px","padding":"0 10px","fontSize":"14px","lineHeight":"24px","color":"#666"}'>{{detail.lianxidianhua}}</div>
				</div>
				<div class="item" :style='{"padding":"4px","margin":"0 0 4px 0","borderColor":"rgba(85, 180, 75,.4)","background":"none","borderWidth":"0 0 1px 0 ","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px 0 0","color":"#333","textAlign":"left","width":"130px","fontSize":"14px","lineHeight":"24px","fontWeight":"bold","height":"40px"}'>鐐瑰嚮娆℃暟</div>
				...
				<div class="btn" :style='{"padding":"10px 0 0","flexWrap":"wrap","display":"flex"}'>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0px 5px 5px 0","outline":"none","color":"#383838","borderRadius":"4px","background":"#acd598","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="isAuth('jiudianxinxi','订酒店')" @click="onAcross('jiudianyuding','','','')" type="warning">订酒店</el-button>
				</div>
			</div>
		...
		<el-tabs class="detail" :style='{"border":"2px solid #a4d9b7","boxShadow":"none","padding":"20px","margin":"20px 0 0 0","borderRadius":"8px","background":"#fff"}' v-model="activeName" type="border-card">
			<el-tab-pane label="閰掑簵浠嬬粛" name="first">
				<div v-html="detail.jiudianjieshao"></div>
			</el-tab-pane>
			<el-tab-pane label="璇勮" name="second">
				<el-form class="add comment" :style='{"padding":"0","margin":"20px 0 20px","position":"relative","background":"none"}' :model="form" :rules="rules" ref="form">
					<el-form-item class="item" :style='{"border":"2px solid #a4d9b7","width":"100%","boxShadow":"inset 0px 0px 48px 0px #f0faf4","borderRadius":"8px","display":"flex","height":"auto"}' label="璇勮" prop="content">
					...
					<el-form-item class="btn" :style='{"width":"100%","padding":"0 0 0 80px","margin":"10px 0 0","justifyContent":"space-around","display":"flex","height":"auto"}'>
						<el-button :style='{"border":"0","cursor":"pointer","padding":"0","margin":"0 20px 0 0","outline":"none","color":"rgba(255, 255, 255, 1)","borderRadius":"20px","background":"#3db769","width":"128px","lineHeight":"40px","fontSize":"14px","height":"40px"}' type="primary" @click="submitForm('form')">绔嬪嵆鎻愪氦</el-button>
						<el-button :style='{"border":"2px solid #3db769","cursor":"pointer","padding":"0","margin":"0 20px 0 0","outline":"none","color":"#3db769","borderRadius":"20px","background":"#eef6f1","width":"128px","lineHeight":"40px","fontSize":"14px","height":"40px"}' @click="resetForm('form')">閲嶇疆</el-button>
					</el-form-item>
				</el-form>
...
<script>
  ...
  export default {
    ...
    getThumbsupOrCrazilyStatus() {
        if(localStorage.getItem("Token")) {
            this.$http.get('storeup/list', {params: {page: 1, limit: 1, type: 21, refid: this.detail.id, tablename: 'jiudianxinxi', userid: localStorage.getItem('userid')}}).then(res => {
              if (res.data.code == 0 && res.data.data.list.length > 0) {
            ...
            this.$http.get('storeup/list', {params: {page: 1, limit: 1, type: 22, refid: this.detail.id, tablename: 'jiudianxinxi', userid: localStorage.getItem('userid')}}).then(res => {
              if (res.data.code == 0 && res.data.data.list.length > 0) {
