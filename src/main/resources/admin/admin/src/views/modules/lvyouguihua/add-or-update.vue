<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="鐩殑鍦? prop="mudedi">
					<el-input v-model="ruleForm.mudedi" placeholder="鐩殑鍦? clearable  :readonly="ro.mudedi"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="鐩殑鍦? prop="mudedi">
					<el-input v-model="ruleForm.mudedi" placeholder="鐩殑鍦? readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="鍑哄彂鏃堕棿" prop="chufashijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.chufashijian" label="鍑哄彂鏃堕棿" prop="chufashijian">
					<el-input v-model="ruleForm.chufashijian" placeholder="鍑哄彂鏃堕棿" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="棰勮澶╂暟" prop="yujitianshu">
					<el-input v-model="ruleForm.yujitianshu" placeholder="棰勮澶╂暟" clearable  :readonly="ro.yujitianshu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="棰勮澶╂暟" prop="yujitianshu">
					<el-input v-model="ruleForm.yujitianshu" placeholder="棰勮澶╂暟" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="鏃呮父璺嚎" prop="lvyouluxian">
					<el-input
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else-if="ruleForm.lvyouluxian" label="鏃呮父璺嚎" prop="lvyouluxian">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#000","fontWeight":"500","display":"inline-block"}'>{{ruleForm.lvyouluxian}}</span>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-if="type!='info'"  label="瑙勫垝鍐呭" prop="guihuaneirong">
					<editor 
						style="min-width: 200px; max-width: 600px;"
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else-if="ruleForm.guihuaneirong" label="瑙勫垝鍐呭" prop="guihuaneirong">
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.guihuaneirong = this.ruleForm.guihuaneirong.replace(reg,'../../../springboot655ms/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
