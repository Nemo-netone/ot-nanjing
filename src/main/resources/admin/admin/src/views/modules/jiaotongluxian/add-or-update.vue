	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="始发�? prop="shifadi">
					<el-input v-model="ruleForm.shifadi" placeholder="始发�? clearable  :readonly="ro.shifadi"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="始发�? prop="shifadi">
					<el-input v-model="ruleForm.shifadi" placeholder="始发�? readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="终点�? prop="zhongdiandi">
					<el-input v-model="ruleForm.zhongdiandi" placeholder="终点�? clearable  :readonly="ro.zhongdiandi"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="终点�? prop="zhongdiandi">
					<el-input v-model="ruleForm.zhongdiandi" placeholder="终点�? readonly></el-input>
				</el-form-item>
