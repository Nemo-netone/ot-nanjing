<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="鏅偣鍚嶇О" prop="jingdianmingcheng">
					<el-input v-model="ruleForm.jingdianmingcheng" placeholder="鏅偣鍚嶇О" clearable  :readonly="ro.jingdianmingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="鏅偣鍚嶇О" prop="jingdianmingcheng">
					<el-input v-model="ruleForm.jingdianmingcheng" placeholder="鏅偣鍚嶇О" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="鏅偣鍦板潃" prop="jingdiandizhi">
					<el-input v-model="ruleForm.jingdiandizhi" placeholder="鏅偣鍦板潃" clearable  :readonly="ro.jingdiandizhi"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="鏅偣鍦板潃" prop="jingdiandizhi">
					<el-input v-model="ruleForm.jingdiandizhi" placeholder="鏅偣鍦板潃" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="闂ㄧエ浠锋牸" prop="menpiaojiage">
					<el-input v-model="ruleForm.menpiaojiage" placeholder="闂ㄧエ浠锋牸" clearable  :readonly="ro.menpiaojiage"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="闂ㄧエ浠锋牸" prop="menpiaojiage">
					<el-input v-model="ruleForm.menpiaojiage" placeholder="闂ㄧエ浠锋牸" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="鏅偣绛夌骇" prop="jingdiandengji">
					<el-input v-model="ruleForm.jingdiandengji" placeholder="鏅偣绛夌骇" clearable  :readonly="ro.jingdiandengji"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="鏅偣绛夌骇" prop="jingdiandengji">
					<el-input v-model="ruleForm.jingdiandengji" placeholder="鏅偣绛夌骇" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="棰勮鏃堕棿" prop="yudingshijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.yudingshijian" label="棰勮鏃堕棿" prop="yudingshijian">
					<el-input v-model="ruleForm.yudingshijian" placeholder="棰勮鏃堕棿" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="澶囨敞" prop="beizhu">
					<el-input v-model="ruleForm.beizhu" placeholder="澶囨敞" clearable  :readonly="ro.beizhu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="澶囨敞" prop="beizhu">
					<el-input v-model="ruleForm.beizhu" placeholder="澶囨敞" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="鎵嬫満" prop="shouji">
					<el-input v-model="ruleForm.shouji" placeholder="鎵嬫満" clearable  :readonly="ro.shouji"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="鎵嬫満" prop="shouji">
					<el-input v-model="ruleForm.shouji" placeholder="鎵嬫満" readonly></el-input>
				</el-form-item>
			</template>
