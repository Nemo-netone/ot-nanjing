<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="景点名称" prop="jingdianmingcheng">
					<el-input v-model="ruleForm.jingdianmingcheng" placeholder="景点名称" clearable  :readonly="ro.jingdianmingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="景点名称" prop="jingdianmingcheng">
					<el-input v-model="ruleForm.jingdianmingcheng" placeholder="景点名称" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="景点地址" prop="jingdiandizhi">
					<el-input v-model="ruleForm.jingdiandizhi" placeholder="景点地址" clearable  :readonly="ro.jingdiandizhi"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="景点地址" prop="jingdiandizhi">
					<el-input v-model="ruleForm.jingdiandizhi" placeholder="景点地址" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="景点等级" prop="jingdiandengji">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="景点等级" prop="jingdiandengji">
					<el-input v-model="ruleForm.jingdiandengji"
						placeholder="景点等级" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="门票价格" prop="menpiaojiage">
					<el-input v-model="ruleForm.menpiaojiage" placeholder="门票价格" clearable  :readonly="ro.menpiaojiage"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="门票价格" prop="menpiaojiage">
					<el-input v-model="ruleForm.menpiaojiage" placeholder="门票价格" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="景点电话" prop="jingdiandianhua">
					<el-input v-model="ruleForm.jingdiandianhua" placeholder="景点电话" clearable  :readonly="ro.jingdiandianhua"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else class="input" label="景点电话" prop="jingdiandianhua">
					<el-input v-model="ruleForm.jingdiandianhua" placeholder="景点电话" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="upload" v-if="type!='info' && !ro.jingdiantupian" label="景点图片" prop="jingdiantupian">
					<file-upload
						tip="点击上传景点图片"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="upload" v-else-if="ruleForm.jingdiantupian" label="景点图片" prop="jingdiantupian">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-if="type!='info'"  label="景点介绍" prop="jingdianjieshao">
					<editor 
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else-if="ruleForm.jingdianjieshao" label="景点介绍" prop="jingdianjieshao">
...
export default {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='jingdiandianhua'){
							this.ruleForm.jingdiandianhua = obj[o];
							this.ro.jingdiandianhua = true;
							continue;
						}
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.jingdianjieshao = this.ruleForm.jingdianjieshao.replace(reg,'../../../springboot655ms/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
