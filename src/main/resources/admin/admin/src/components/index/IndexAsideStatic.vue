		...
		<el-scrollbar wrap-class="scrollbar-wrapper">
			<el-menu :default-openeds="[]" :unique-opened="true" :style='{"border":0,"padding":"0","listStyle":"none","margin":"0","position":"relative","background":"#FFF"}' class="el-menu-vertical-demo" default-active="0">
				...
				<!-- <el-menu-item index="0" @click="menuHandler('')">
					...
					<span :style='{"color":"inherit","verticalAlign":"middle","fontSize":"14px"}'>绯荤粺棣栭〉</span>
				</el-menu-item> -->
				...
				<el-submenu index="1">
					<template slot="title">
						...
						<span :style='{"color":"inherit","verticalAlign":"middle","fontSize":"14px"}'>涓汉涓績</span>
					</template>
					<el-menu-item index="1-1" @click="menuHandler('updatePassword')">淇敼瀵嗙爜</el-menu-item>
					<el-menu-item index="1-2" @click="menuHandler('center')">涓汉淇℃伅</el-menu-item>
				</el-submenu>
