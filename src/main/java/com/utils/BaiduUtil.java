...
public class BaiduUtil {
    ...
    //设置APPID/AK/SK
    public static final String APP_ID = envOrDefault("BAIDU_APP_ID", "");
    public static final String API_KEY = envOrDefault("BAIDU_API_KEY", "");
    public static final String SECRET_KEY = envOrDefault("BAIDU_SECRET_KEY", "");
